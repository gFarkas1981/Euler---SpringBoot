...
public class WatermarkPdf {
    ...
    public void watermarkPdf(File SRC, File DEST) throws Exception {

        PdfDocument pdfDoc = new PdfDocument(new PdfReader(String.valueOf(SRC)), new PdfWriter(String.valueOf(DEST)));
        ...
        for (int i = 1; i <= n; ++i) {
            ...
            PdfPageOrientation.pdfPageOrientation(SRC, i);
            Paragraph p;
            Date date = new Date();
            SimpleDateFormat ft = new SimpleDateFormat("MM.dd.yyyy 'at' HH:mm:ss zzz");
